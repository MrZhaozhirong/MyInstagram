...
import com.pixel.myinstagram.adapter.PhotoFiltersAdapter;
import com.pixel.myinstagram.view.RevealBackgroundView;
...
public class TakePhotoActivity extends BaseActivity
    ...
    ImageView ivTakenPhoto; //用于显示成像的照片
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        vUpperPanel.getViewTreeObserver().addOnPreDrawListener(
    ...
    public void setupRevealBackground(Bundle savedInstanceState) {
        ...
        vRevealBackground.setOnStateChangeListener(this);//Override onStateChange
    ...
    public CameraHost getCameraHost() {
        return new ZzrCameraHost(this);
    }

    class ZzrCameraHost extends SimpleCameraHost{

        private Camera.Size previewSize;

        public ZzrCameraHost(Context _ctxt) {
            super(_ctxt);
        }
